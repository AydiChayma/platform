...
const options1 = [
    { imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/4c9b46e4510a6f5dc8fb9dcd0f78831c239bcde29f2a9f7a05d6b532a29a66c9?apiKey=875c657f39b24f02b57f3f224a6dff5b&&apiKey=875c657f39b24f02b57f3f224a6dff5b", buttonText: "Teacher" },
];
const options = [
    { imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/81945ab0b8644262bea0ac5ec8ddae047c77def70c8b77e2a17cff5eadcbf290?apiKey=875c657f39b24f02b57f3f224a6dff5b&&apiKey=875c657f39b24f02b57f3f224a6dff5b", buttonText: "Parent" }
];
                    ...
                    <div className={styles.optionsWrapper}>
                        {options1.map((option, index) => (
                            <div key={index} className={styles.optionColumn1}>
                                <Option imageSrc={option.imageSrc} buttonText={option.buttonText} />
                            </div>
                        ))}
